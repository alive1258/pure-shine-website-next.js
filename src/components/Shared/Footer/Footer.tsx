...
/* ================= CONSTANTS ================= */
// TODO: replace with the cleaning company's real contact details — same
// placeholders used in Navbar / ContactPage.
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div>
              ...
              <p className="mt-4 text-brand-100/70 text-sm max-w-sm leading-relaxed">
                Reliable, eco-friendly cleaning for homes and businesses.
                Trained, background-checked pros and a 100% satisfaction
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-brand-100/60 text-center md:text-left">
            © {currentYear}{" "}
            <span className="text-gold-400">Pure Shine Cleaning</span>. All
            rights reserved.
          </p>
